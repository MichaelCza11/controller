...
public class LibroControllerTestIntegracion {
    ...
    public void testFinAll() throws Exception {
        Libro libro = new Libro(1,"Las intermitencias de la muerte","Editorial Canminho",214,"Primera Edicion","Esp","Realismo Magico","Pasta blanda","ISBN 001",1000,"Las intermitencias de la muerte","ds","15.99");
